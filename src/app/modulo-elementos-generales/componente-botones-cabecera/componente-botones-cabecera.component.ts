...
export class ComponenteBotonesCabeceraComponent {
  ...
  redirigir(tipo: string) {
    ...
    if (tipo === 'crearIncidencia' && this.rutaCrearIncidencia) {
      this.router.navigate([this.rutaCrearIncidencia]);
    }
  }
